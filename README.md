...
**Live:** [https://atsdev15.github.io/Fexsa-website/](https://atsdev15.github.io/Fexsa-website/)
...
The contact form sends submissions to **info@fexsa.net**.
...
If no backend is configured, the form falls back to opening the user's default email client with pre-filled content addressed to `info@fexsa.net`.
...
For the live site, ensure the production email (`info@fexsa.net`) is set in `src/components/Contact.jsx`:

1. In the `handleSubmit` function, verify `to_email: 'info@fexsa.net'`
